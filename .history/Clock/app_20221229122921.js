...
const days = Math.round(difference / (1000 * 86400));
const hours = Math.round(difference / (1000 * 3600) - days * 24);
const minutes = difference / (1000 * 3600) - days * 24;

console.log({hours, mi
});
